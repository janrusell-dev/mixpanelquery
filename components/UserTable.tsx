...
export function UserTable() {
  ...
  const isLoading = useFilteredUsersStore((state) => state.isLoading);
              ...
              {headerGroup.headers.map((header) => (
                ...
                >
                  ...
                  <div
                    ...
                    className={`absolute right-0 top-0 h-full w-2 cursor-col-resize bg-slate-200 opacity-0 group-hover:opacity-100 ${
